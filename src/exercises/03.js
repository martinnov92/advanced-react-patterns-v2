...
class Toggle extends React.Component {
  ...
  static Button = (props) => (
    <ToggleContext.Consumer>
      { (ctxValue) => <Switch on={ctxValue.on} onClick={ctxValue.toggle} {...props} /> }
    </ToggleContext.Consumer>
  )
  ...
  // NOTE: Uložím toggle fn do statu, protože pokud bych nechal object v ToggleContext.Provider
  // bude se object měnit s každým renderem, což by mohlo mít dopad na výkon a potom předám do provideru
  // celý state => rerender se zavolá jen při změně state
